...
\begin{document}
    ...
    eine mit Schwebung.
    In Aufgabe 11 soll der Koplungsgrad $K$ bestimmt werden. Diesen bestimmt man mithilfe der beide
    Winkelgeschwindigkeiten

    \begin{align}
        K = \frac{\omega_{geg}^2 - \omega_{geg}^2}{\omega_{geg}^2 + \omega_{geg}^2}
    \end{align}

    In Aufgabe 12 soll aus der Schwebung 
    \subsection{Ergebnisse}
