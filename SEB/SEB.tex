...
\begin{document}
    ...
    \begin{figure}
        ...
        \label{fig:Gleitr}
    \end{figure}
    Im Graphen ? werden die Messdaten und die angenommenen Durchschittsparabeln dargestellt. An jede Messreihe wurde 
    einzeln eine Parabel gefittet und anschießend der Mittelwert der Parameter bestimmt, um die
