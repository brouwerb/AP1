...
\begin{document}
    ...
    Entgegen der Erwartung ist der gemessene Wert von $\mu_G$ kleiner als $\mu_H$. Beide Werte liegen jedoch so nah bei einander
    und haben so große Unsicherheiten, dass diese theoretisch nicht mögliche Abweichungen durch die Unsicherheit in der Messung begründet werden kann.
