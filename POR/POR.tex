...
\begin{document}
    ...
    wird wie im ersten Versuch die Theoriekurve gefittet. Auch für die Dämpfungsfrequenz und für die
    ...
    digital gemessene Dämpfungskonstante und Eigenfrequenz angegeben. In Graph \ref{fig:eigenfrequenz} kann die digitale Messung und die gefittete
    Funktion gesehen werden. Die gleiche einhüllende Exponentialfunktion sowie die Daten der händischen Amplitudenmessung
    wurden im Graphen ? dargestellt.
    \begin{table}[H]
        \centering
        \begin{tabular}{c c c} 
            & Hand & Computer \\ \hline
