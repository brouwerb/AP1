...
\begin{document}
   ...
   Durch die gefittete Exponenitalfunktion
    ...
    \begin{table}
        ...
        \\ Anm: Die Werte wurden mit einer viel höheren Genauigkeit in die Rechnung übernommen und erst anschließend gerundet. Daher kommt die Diskrepanz zur Berechung mit den hier angegeben Werten.} \label{tab:dampfmess}
        \end{adjustwidth}
    \end{table}
    \begin{figure}
        \centering
