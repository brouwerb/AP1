...
\begin{document}
    ...
    \begin{table}[!th]
        ...
        \begin{tabular}{c | c | c | c}
           & Messig & Kupfer & Plexiglas \\ \hline
            ...
            Länge des Stabs & $140,7cm$ & $150,1cm$ & $74,6cm$ \\ \hline
            Elastizitätsmodul
        \end{tabular}
    ...
    \begin{align}
        ...
        &= \sqrt{64 \frac{\bar{l}^4 \bar{\rho}^2}{\bar{t}^6} \cdot u_t(\bar{t}) +
        64 \frac{\bar{l}^2 \bar{\rho}^2}{\bar{t}^4} \cdot u_l(\bar{l}) +
        16 \frac{\bar{l}^4}{\bar{t}^4} \cdot u_{\rho}(\bar{\rho})
        }
    \end{align}
