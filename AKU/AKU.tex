...
\begin{document}
    ...
    \subsection{Ergebnisse}
    Im Graph sieht man den Laufzeitunterschied $\Delta t$ auf der Y-Achse verglichen mit dem Abstand der Mikrophone
    auf der Y-Achse. Man kann erkennen, dass die Ausgleichsgerade nicht durch den Ursprung geht, das liegt daran,
    ...
    Die Ausgleichsgeraden der Graphen wurde so gezeichnet dass
    \begin{align}
